...
export default function HistorialVentas(){
    ...
    const [tableData, setTableData] = useState([]);
        ...
        const getTableData = async() => {
            try{
                const data = await sentences.allDataAllRelations("transaccion", ["elementos", "empleado", "venta", "persona", "obra"])
                const dataFiltrada = data.filter((dato) => {data.venta});
        ...
        return(
            <div className="h-full flex flex-col">
                <h1 className="text-2xl font-bold text-gray-800 mb-4">Historial de Ventas</h1>
