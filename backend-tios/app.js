...
import proceso_empleadosRoutes from './routes/proceso_empleadosRoutes.js';
import proceso_herramientasRoutes from './routes/proceso_herramientasRoutes.js';
import proceso_inventarioRoutes from './routes/proceso_inventarioRoutes.js';
import procesoRoutes from './routes/ProcesoRoutes.js';
import proformaRoutes from './routes/ProformaRoutes.js';
import puntoRoutes from './routes/PuntoRouter.js';
...
app.use('/proceso_empleados', verificarToken, proceso_empleadosRoutes);
app.use('/proceso_herramientas', verificarToken, proceso_herramientasRoutes);
app.use('/proceso_inventario', verificarToken, proceso_inventarioRoutes);
app.use('/proceso', verificarToken, procesoRoutes);
app.use('/proforma', verificarToken, proformaRoutes);
app.use('/punto', verificarToken, puntoRoutes);
app.use('/tarea', verificarToken, tareaRoutes);
...
app.use('/proceso_empleados', proceso_empleadosRoutes);
app.use('/proceso_herramientas', proceso_herramientasRoutes);
app.use('/proceso_inventario', proceso_inventarioRoutes);
